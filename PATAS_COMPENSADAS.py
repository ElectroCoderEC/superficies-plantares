        ...
        if FUNCIONAL:
            ...
            for contour in contours:
                ...
                if area > 4050:  # tamaño de pie
                    ...
                    # print(Tcm) distancia de la presion completa
                ...
                for contour in contornos_izquierdo:
                    ...
                    if right is not None and right_top is not None:
                        ...
                        if np.linalg.det(A) != 0:
                            ...
                            # print("Punto de intersección:", (intersection_x, intersection_y))
                        ...
                        Xcm = distanceX / factor  # Distancia fundamental X izquierda
                        # Texto X
